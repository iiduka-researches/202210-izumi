...
from optimizer.scg_param import get_scg1_param_fn,get_scg2_param_fn


class SCGAdabelief(Optimizer):
    def __init__(self, params, period: int, lr=1e-3, betas=(0.9, 0.999), eps=1e-8, weight_decay=0.0, amsgrad=False,
        ...
        super(SCGAdabelief, self).__init__(params, defaults)

    def __setstate__(self, state):
        super(SCGAdabelief, self).__setstate__(state)
