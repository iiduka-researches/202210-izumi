...
from optimizer.scg_param import get_scg3_param_fn
...
class Adam2(Optimizer):
    ...
    def __init__(self, params, lr='D0', beta='D1',betas=(0.9, 0.999), eps=1e-8, weight_decay=0, amsgrad=False) -> None:
        if not 0.0 <= eps:
        ...
        defaults = dict(lr=lr, beta=beta, betas=betas, eps=eps,
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            ...
            for p in group['params']:
                ...
                #alpha_param_fn = get_alpha_param_fn(group['alpha_type'])
                #beta_param_fn = get_beta_param_fn(group['beta_type'])
